...
st.write("此应用让国内的人也可以体验使用增加了记忆的ChatGPT。只需在上面的方框内打字提问，回车/前往即可。您的每次使用我都需要支付调用OpenAI API的费用，使用后觉得不错请考虑扫码微信支付¥10人民币以便我能够一直提供这个AI小程序。如果常用可以支付¥388包月或¥2888包年，谢谢！")
